...
testBuild = do
  ...
  let track2 = buildTrack 122 (Time 7 4) m2
  let track3 = buildTrack 122 (Time 3 4) m3

  let rhythm = [track2,track2,track2,
                track1,track3,track1,track3,
                track3,track3,track3]
