...
testBuild = do
  ...
  let track1 = buildTrack 120 (M (Time 3 4) ".") drum1
  let track2 = buildTrack 120 (M (Time 3 4) ".x.") drum2
  let track3 = buildTrack 120 (M (Time 3 4) "x.x") drum3
  let track4 = buildTrack 120 (M (Time 3 4) "x.") drum4
  let track5 = buildTrack 120 (M (Time 3 4) ".x") drum5
